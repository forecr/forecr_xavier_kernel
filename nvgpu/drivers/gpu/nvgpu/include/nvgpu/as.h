 ...
 * by gk20a_as_alloc_share(). Release allocated VM using gk20a_vm_release_share().
 *
 ...
 *					structure
 *
 * Allocate the gk20a_as_share structure and the VM associated with it using gk20a_vm_alloc_share(),
 *  based on the provided \a big_page_size and NVGPU_AS_ALLOC_* \a flags.
 * Generate unique address space id using generate_unique_share_id().
