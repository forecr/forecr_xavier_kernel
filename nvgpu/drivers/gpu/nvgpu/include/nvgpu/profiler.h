...
struct nvgpu_profiler_object {
	...
	/* Lock to serialize bind/unbind calls */
	struct nvgpu_mutex bind_lock;
...
int nvgpu_profiler_unbind_hes_cwd(struct gk20a *g,
		u32 gr_instance_id,
		bool is_ctxsw);
...
int nvgpu_profiler_alloc_pma_stream(struct nvgpu_profiler_object *prof, u32 *pma_channel_id);
void nvgpu_profiler_free_pma_stream(struct nvgpu_profiler_object *prof, u32 pma_channel_id);
