...
/*PG defines*/
/*!
 * The following definition of ENGINE_ID applies to all NV2080_CTRL_MC
 * commands that are related to PowerGating.
 */
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_GRAPHICS       (0x00000000)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VIDEO          (0x00000001)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_GR_PASSIVE     (0x00000001)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_GR_RG          (0x00000002)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_DI             (0x00000003)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS             (0x00000004)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_EI             (0x00000005)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_LTC         (0x00000006)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_PASSIVE     (0x00000007)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_EI_PASSIVE     (0x00000008)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_DFPR           (0x00000009)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_DIFR_SW_ASR (0x0000000A)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_DIFR_CG     (0x0000000B)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVDEC_RPG  (0x0000000C)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVENC_RPG  (0x0000000D)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_OFA_RPG    (0x0000000E)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVJPG_RPG  (0x0000000F)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_FB_XBAR_PG  (0x00000010)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVDEC_PG   (0x00000011)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVENC_PG   (0x00000012)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_OFA_PG     (0x00000013)
#define NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MAX            (0x00000014)

/* Identifier for each PG */
#define PMU_PG_ELPG_ENGINE_ID_GRAPHICS        NV2080_CTRL_MC_POWERGATING_ENGINE_ID_GRAPHICS
#define PMU_PG_ELPG_ENGINE_ID_GR_RG           NV2080_CTRL_MC_POWERGATING_ENGINE_ID_GR_RG
#define PMU_PG_ELPG_ENGINE_ID_MS              NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS
#define PMU_PG_ELPG_ENGINE_ID_MS_LTC          NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MS_LTC
#define PMU_PG_ELPG_ENGINE_ID_GR_GRP_LAST     PMU_PG_ELPG_ENGINE_ID_MS_LTC
#define PMU_PG_ELPG_ENGINE_ID_VID_NVDEC       NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVDEC_PG
#define PMU_PG_ELPG_ENGINE_ID_VID_NVENC       NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_NVENC_PG
#define PMU_PG_ELPG_ENGINE_ID_VID_OFA         NV2080_CTRL_MC_POWERGATING_ENGINE_ID_VID_OFA_PG
#define PMU_PG_ELPG_ENGINE_ID_INVALID_ENGINE  NV2080_CTRL_MC_POWERGATING_ENGINE_ID_MAX
#define PMU_PG_ELPG_ENGINE_MAX                PMU_PG_ELPG_ENGINE_ID_INVALID_ENGINE

/* Ctrl Ids For FLCG */
#define PMU_CTRL_ID_CG_FLCG_CTRL_NVDCLK			(0x0000U)
#define PMU_CTRL_ID_CG_FLCG_CTRL_GPCCLK			(0x0001U)

/* Ctrl Id for SYSCLK Slowdown */
#define PMU_CTRL_ID_CSD_CTRL_SYSCLK		(0x0002U)

/* FGPG CTRL ID */
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_GR		0x0U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVDEC0	0x1U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVDEC1	0x2U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVENC0	0x5U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVENC1	0x6U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVJPG0	0x9U
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVJPG1	0xAU
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID_OFA	0xDU
#define NV_PMU_LPWR_SEQ_FGPG_CTRL_ID__COUNT	0xEU

/* FGPG Bitmask for when it is enabled for all the supported GR and Video engines*/
#define PG_FGPG_ALL_ENGINE_ENABLED_BITMASK	0X2667U

/*
 * GB20C-specific FGPG engine mask - used via PMU ops structure
 * for chip-specific compatibility without touching legacy masks
 */
#define PG_FGPG_ALL_ENGINE_ENABLED_BITMASK_GB20C	0x2023U
...
#define NV_PMU_RPC_ID_PG_LOADING_PRIV_BLOCKER_INIT			0x02U
#define NV_PMU_RPC_ID_PG_LOADING_INIT						0x13U
#define NV_PMU_RPC_ID_PG_LOADING_AP_INIT					0x17U
#define NV_PMU_RPC_ID_PG_LOADING_AP_CTRL_INIT_AND_ENABLE	0x18U
#define NV_PMU_RPC_ID_PG_LOADING_SEQ_FGPG_INIT				0x21U
#define NV_PMU_RPC_ID_PG_LOADING_FLCG_INIT					0x22U
...
#define NV_PMU_RPC_ID_PG_CG_ELCG_STATE_CHANGE			0x12U
#define NV_PMU_RPC_ID_PG_CG_ELCG_STAT_GET				0x13U
#define NV_PMU_RPC_ID_PG_CG_ELCG_MON_START				0x14U
#define NV_PMU_RPC_ID_PG_CG_ELCG_MON_CONFIG				0x15U
#define NV_PMU_RPC_ID_PG_CSD_INIT						0x16U
#define NV_PMU_RPC_ID_PG_CSD_CTRL_ENABLE				0x17U
#define NV_PMU_RPC_ID_PG_CSD_CTRL_THRESHOLD_UPDATE		0x18U
#define NV_PMU_RPC_ID_PG_CG_FLCG_CTRL_ENABLE			0x19U
#define NV_PMU_RPC_ID_PG_CG_FLCG_CTRL_THRESHOLD_UPDATE	0x1AU
#define NV_PMU_RPC_ID_PG_SEQ_FGPG_THRESHOLD_UPDATE		0x1FU
#define NV_PMU_RPC_ID_PG_SEQ_FGPG_STATE_CHANGE			0x21U

/*!
 * RPC calls serviced by LPWR_LP unit.
 */
#define NV_PMU_RPC_ID_LPWR_LP_MON_START		0x07U
#define NV_PMU_RPC_ID_LPWR_LP_MON_STAT_GET	0x08U
#define NV_PMU_RPC_ID_LPWR_LP_CSD_STAT_GET	0x0CU
 ...
 * FGPG CTRL ID
 */
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_GR     0x0U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVDEC0 0x1U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVDEC1 0x2U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVENC0 0x5U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVENC1 0x6U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVJPG0 0x9U
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_NVJPG1 0xAU
#define NVGPU_PMU_LPWR_SEQ_FGPG_CTRL_ID_OFA    0xDU
