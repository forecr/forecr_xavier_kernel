 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_CE_GB10B_H
#define NVGPU_HW_CE_GB10B_H
...
#define ce_lce_intr_en_ctx_load_after_halt_m()                 (U32(0x1U) << 9U)
#define ce_lce_intr_en_cc_no_resources_m()                    (U32(0x1U) << 12U)
...
#define ce_intr_status_ctx_load_after_halt_pending_f()                  (0x200U)
#define ce_intr_status_ctx_load_after_halt_reset_f()                    (0x200U)
#define ce_intr_status_cc_no_resources_pending_f()                     (0x1000U)
#define ce_intr_status_cc_no_resources_reset_f()                       (0x1000U)
...
#define ce_grce_config_r(i)\
		(nvgpu_safe_add_u32(0x001041c0U, nvgpu_safe_mult_u32((i), 4U)))
#define ce_grce_config__size_1_v()                                 (0x00000002U)
#define ce_grce_config_shared_lce_f(v)                   ((U32(v) & 0xfU) << 0U)
#define ce_grce_config_shared_lce_m()                          (U32(0xfU) << 0U)
#define ce_grce_config_shared_lce_v(r)                      (((r) >> 0U) & 0xfU)
#define ce_grce_config_shared_lce_none_f()                                (0xfU)
#define ce_grce_config_shared_lce_config_0_init_f()                       (0x3U)
#define ce_grce_config_shared_lce_config_1_init_f()                       (0xfU)
#define ce_grce_config_shared_f(v)                      ((U32(v) & 0x1U) << 30U)
#define ce_grce_config_shared_m()                             (U32(0x1U) << 30U)
#define ce_grce_config_shared_config_0_init_f()                    (0x40000000U)
#define ce_grce_config_shared_config_1_init_f()                           (0x0U)
...
#define ce_pce2lce_config_r(i)\
		(nvgpu_safe_add_u32(0x00104100U, nvgpu_safe_mult_u32((i), 4U)))
#define ce_pce2lce_config__size_1_v()                              (0x00000002U)
#define ce_pce2lce_config_pce_assigned_lce_f(v)          ((U32(v) & 0xfU) << 0U)
#define ce_pce2lce_config_pce_assigned_lce_m()                 (U32(0xfU) << 0U)
#define ce_pce2lce_config_pce_assigned_lce_v(r)             (((r) >> 0U) & 0xfU)
#define ce_pce2lce_config_pce_assigned_lce_none_f()                       (0xfU)
#define ce_pce2lce_config_pce_assigned_lce_config_0_init_f()              (0x2U)
#define ce_pce2lce_config_pce_assigned_lce_config_1_init_f()              (0x3U)
#define ce_lce_ctrl_r(i)\
		(nvgpu_safe_add_u32(0x00104060U, nvgpu_safe_mult_u32((i), 4U)))
#define ce_lce_ctrl_reset_assert_f()                                      (0x0U)
#define ce_lce_ctrl_reset_deassert_f()                                    (0x1U)
#define ce_lce_ctrl_status_v(r)                             (((r) >> 1U) & 0x7U)
#define ce_lce_ctrl_status_asserted_v()                            (0x00000000U)
#define ce_lce_ctrl_status_deasserted_v()                          (0x00000002U)
#endif
