 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_PNVENC_GB10B_H
#define NVGPU_HW_PNVENC_GB10B_H
...
#define pnvenc_errslice0_missionerr_status_r(i)\
		(nvgpu_safe_add_u32(0x001c9438U, nvgpu_safe_mult_u32((i), 16384U)))
#define pnvenc_falcon_intr_ctrl2_r(i)\
		(nvgpu_safe_add_u32(0x001cb270U, nvgpu_safe_mult_u32((i), 16384U)))
#define pnvenc_falcon_intr_ctrl3_r(i)\
		(nvgpu_safe_add_u32(0x001cb278U, nvgpu_safe_mult_u32((i), 16384U)))
...
#define pnvenc_falcon_safety_mailbox_r(i)\
		(nvgpu_safe_add_u32(0x001c82f0U, nvgpu_safe_mult_u32((i), 16384U)))
#endif
