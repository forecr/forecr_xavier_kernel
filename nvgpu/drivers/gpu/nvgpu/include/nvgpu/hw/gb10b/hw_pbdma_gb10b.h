 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_PBDMA_GB10B_H
#define NVGPU_HW_PBDMA_GB10B_H
...
#define pbdma_gp_base_r(i)\
		(nvgpu_safe_add_u32(0x00040090U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_gp_get_r(i)\
		(nvgpu_safe_add_u32(0x00040098U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_gp_put_r(i)\
		(nvgpu_safe_add_u32(0x000400c0U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_get_r(i)\
		(nvgpu_safe_add_u32(0x00040080U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_get_hi_r(i)\
		(nvgpu_safe_add_u32(0x00040084U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_put_r(i)\
		(nvgpu_safe_add_u32(0x00040088U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_put_hi_r(i)\
		(nvgpu_safe_add_u32(0x0004008cU, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_pb_header_r(i)\
		(nvgpu_safe_add_u32(0x00040420U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_misc_fetch_state_r(i)\
		(nvgpu_safe_add_u32(0x000400b4U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_pb_segment_extended_base_r(i)\
...
#define pbdma_hdr_shadow_r(i)\
		(nvgpu_safe_add_u32(0x000400ccU, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_subdevice_r(i)\
		(nvgpu_safe_add_u32(0x0004003cU, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_method0_r(i)\
		(nvgpu_safe_add_u32(0x00040400U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_method1_r(i)\
		(nvgpu_safe_add_u32(0x00040408U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_method2_r(i)\
		(nvgpu_safe_add_u32(0x00040410U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_method3_r(i)\
		(nvgpu_safe_add_u32(0x00040418U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_signature_r(i)\
		(nvgpu_safe_add_u32(0x00040038U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_signature_sw_zero_f()                                       (0x0U)
#define pbdma_hce_ctrl_r(i)\
		(nvgpu_safe_add_u32(0x00040054U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_hce_ctrl_hce_priv_mode_yes_f()                             (0x20U)
#define pbdma_hce_dbg0_r(i)\
		(nvgpu_safe_add_u32(0x00040150U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_hce_dbg1_r(i)\
		(nvgpu_safe_add_u32(0x00040154U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_intr_0_r(i)\
		(nvgpu_safe_add_u32(0x00040108U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_intr_0__size_1_v()                                   (0x0000000eU)
...
#define pbdma_intr_0_en_set_tree__size_1_v()                       (0x0000000eU)
...
#define pbdma_intr_0_en_clear_tree_r(i,j)\
		...
		nvgpu_safe_mult_u32((i), 2048U)), nvgpu_safe_mult_u32((j), 4U)))
#define pbdma_intr_0_en_clear_tree__size_1_v()                     (0x0000000eU)
...
#define pbdma_misc_execute_state_r(i)\
		(nvgpu_safe_add_u32(0x00040050U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_misc_execute_state_target_engine_f(v)      ((U32(v) & 0x3U) << 0U)
#define pbdma_misc_execute_state_target_eng_ctx_valid_true_f()            (0x4U)
#define pbdma_misc_execute_state_target_ce_ctx_valid_true_f()             (0x8U)
#define pbdma_misc_execute_state_config_auth_level_privileged_f()      (0x2000U)
#define pbdma_set_channel_info_r(i)\
		(nvgpu_safe_add_u32(0x00040058U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_channel_r(i)\
		(nvgpu_safe_add_u32(0x00040120U, nvgpu_safe_mult_u32((i), 2048U)))
#define pbdma_channel_gfid_v(r)                           (((r) >> 16U) & 0x3fU)
#define pbdma_next_channel_r(i)\
		(nvgpu_safe_add_u32(0x00040124U, nvgpu_safe_mult_u32((i), 2048U)))
...
#define pbdma_cfg0__size_1_v()                                     (0x0000000eU)
