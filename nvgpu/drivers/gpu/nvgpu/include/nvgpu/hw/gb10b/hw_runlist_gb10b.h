 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_RUNLIST_GB10B_H
#define NVGPU_HW_RUNLIST_GB10B_H

#include <nvgpu/types.h>
#include <nvgpu/static_analysis.h>

#define runlist_config_r()                                         (0x00000000U)
...
#define runlist_engine_status1_next_gfid_v(r)              (((r) >> 8U) & 0x3fU)
...
#define runlist_single_gfid_mode_r()                               (0x000000b8U)
...
#define runlist_intr_ctrl__size_1_v()                              (0x00000002U)
