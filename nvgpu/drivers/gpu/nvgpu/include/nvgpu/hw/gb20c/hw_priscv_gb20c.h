 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_PRISCV_GB20C_H
#define NVGPU_HW_PRISCV_GB20C_H
...
#define priscv_priscv_br_retcode_result_init_f()                          (0x0U)
...
#define priscv_priscv_bcr_dmaaddr_stage2_pkcparam_lo_r()           (0x00000698U)
#define priscv_priscv_bcr_dmaaddr_stage2_pkcparam_hi_r()           (0x0000069cU)
#define priscv_priscv_bcr_dmacfg_r()                               (0x0000066cU)
#define priscv_priscv_bcr_dmacfg_target_coherent_system_f()               (0x1U)
#define priscv_priscv_bcr_dmacfg_target_noncoherent_system_f()            (0x2U)
#define priscv_priscv_bcr_dmacfg_pointer_walking_true_f()          (0x10000000U)
...
#define priscv_riscv_tracectl_r()                                  (0x00000400U)
#define priscv_riscv_trace_rdidx_r()                               (0x00000404U)
#define priscv_riscv_trace_rdidx_rdidx_f(v)             ((U32(v) & 0xffU) << 0U)
#define priscv_riscv_trace_rdidx_maxidx_v(r)              (((r) >> 16U) & 0xffU)
#define priscv_riscv_trace_wtidx_r()                               (0x00000408U)
#define priscv_riscv_trace_wtidx_wtidx_v(r)               (((r) >> 24U) & 0xffU)
#define priscv_riscv_tracepc_hi_r()                                (0x00000410U)
#define priscv_riscv_tracepc_lo_r()                                (0x0000040cU)
#define priscv_riscv_intr_status_r()                               (0x00000394U)
#define priscv_riscv_fault_containment_srcstat_r()                 (0x00000700U)
