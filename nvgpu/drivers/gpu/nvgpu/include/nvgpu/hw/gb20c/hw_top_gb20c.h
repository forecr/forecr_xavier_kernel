 ...
 *         of register <x>.
 */
#ifndef NVGPU_HW_TOP_GB20C_H
#define NVGPU_HW_TOP_GB20C_H

#include <nvgpu/types.h>
#include <nvgpu/static_analysis.h>

#define top_num_gpcs_r()                                           (0x00022430U)
#define top_num_gpcs_value_v(r)                      (((r) >> 0U) & 0xffffffffU)
#define top_tpc_per_gpc_r()                                        (0x00022434U)
#define top_tpc_per_gpc_value_v(r)                   (((r) >> 0U) & 0xffffffffU)
#define top_num_fbps_r()                                           (0x00022438U)
#define top_num_fbps_value_v(r)                      (((r) >> 0U) & 0xffffffffU)
#define top_ltc_per_fbp_r()                                        (0x00022450U)
#define top_ltc_per_fbp_value_v(r)                   (((r) >> 0U) & 0xffffffffU)
#define top_slices_per_ltc_r()                                     (0x0002245cU)
#define top_slices_per_ltc_value_v(r)                (((r) >> 0U) & 0xffffffffU)
#define top_num_ltcs_r()                                           (0x00022454U)
#define top_num_ltcs_value_v(r)                      (((r) >> 0U) & 0xffffffffU)
#define top_num_ces_r()                                            (0x00022444U)
#define top_num_ces_value_v(r)                       (((r) >> 0U) & 0xffffffffU)
#define top_num_pes_per_gpc_r()                                    (0x00022460U)
#define top_num_pes_per_gpc_value_v(r)               (((r) >> 0U) & 0xffffffffU)
#define top_num_rop_per_gpc_r()                                    (0x00022480U)
#define top_num_rop_per_gpc_value_v(r)               (((r) >> 0U) & 0xffffffffU)
#define top_device_info_cfg_r()                                    (0x000224fcU)
#define top_device_info_cfg_version_v(r)                    (((r) >> 0U) & 0xfU)
#define top_device_info_cfg_version_init_v()                       (0x00000003U)
