 ...
 * NVGPU_PREEMTION_MODE_COMPUTE_CTA and NVGPU_PREEMTION_MODE_COMPUTE_CILP
 * compute preemption modes as valid preemption modes.
 * Any other preemption mode is invalid.
 *
