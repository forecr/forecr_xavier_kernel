			      ...
			      u64 blk_size, u64 flags)
{
	...
	(void) snprintf(buddy_name, (sizeof(buddy_name)) - (sizeof("-src")),
					"%s", name);
	(void) snprintf(buddy_name + strlen(buddy_name),
			nvgpu_safe_sub_u64(sizeof(buddy_name), strlen(buddy_name)), "%s", "-src");
