...
/*
 * Forward declaration for clkClkDomainGetApiDomainByIndex function
 */
extern s32 clkClkDomainGetApiDomainByIndex(struct gk20a *g, u32 *api_domain, u32 index);

/* Forward declaration for power management data access */
