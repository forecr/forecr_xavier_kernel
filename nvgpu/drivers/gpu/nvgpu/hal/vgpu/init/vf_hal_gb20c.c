...
#endif
#include "hal/init/hal_gb20c_litter.h"
...
#include "hal/vgpu/init/vf_hal_gb20c.h"

static int vf_gb20c_init_gpu_characteristics(struct gk20a *g)
{
	int err;
	...
	nvgpu_set_enabled(g, NVGPU_SUPPORT_MULTIMEDIA_TRACE, true);
#endif

	return 0;
}

static const struct gops_acr vf_gb20c_ops_acr = {
	.acr_init = nvgpu_acr_init,
	.acr_construct_execute = nvgpu_acr_construct_execute,
};

#ifdef CONFIG_NVGPU_DGPU
static const struct gops_bios vf_gb20c_ops_bios = {
	/* This is specific to dGPU. Disable it for iGPU. */
	.bios_sw_init = NULL,
};
#endif

static const struct gops_ltc_intr vf_gb20c_ops_ltc_intr = {
	.configure = NULL,
	.isr = NULL,
	.en_illegal_compstat = NULL,
};

static const struct gops_ltc vf_gb20c_ops_ltc = {
	...
	.set_l2_max_ways_evict_last = gb10b_set_l2_max_ways_evict_last,
	.get_l2_max_ways_evict_last = gb10b_get_l2_max_ways_evict_last,
	.set_l2_sector_promotion = gb10b_set_l2_sector_promotion,
#endif /* CONFIG_NVGPU_DEBUGGER */
};

#ifdef CONFIG_NVGPU_COMPRESSION
static const struct gops_cbc vf_gb20c_ops_cbc = {
...
static const struct gops_ce vf_gb20c_ops_ce = {
...
static const struct gops_gr_ctxsw_prog vf_gb20c_ops_gr_ctxsw_prog = {
...
static const struct gops_gr_config vf_gb20c_ops_gr_config = {
...
static const struct gops_gr_setup vf_gb20c_ops_gr_setup = {
...
#ifdef CONFIG_NVGPU_GRAPHICS
static const struct gops_gr_zbc vf_gb20c_ops_gr_zbc = {
	.add_color = NULL,
...
#ifdef CONFIG_NVGPU_GRAPHICS
static const struct gops_gr_zcull vf_gb20c_ops_gr_zcull = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_gr_hwpm_map vf_gb20c_ops_gr_hwpm_map = {
...
static const struct gops_gr_falcon vf_gb20c_ops_gr_falcon = {
	.init_ctx_state = vgpu_gr_init_ctx_state,
	.load_ctxsw_ucode = NULL,
};

#ifdef CONFIG_NVGPU_FECS_TRACE
static const struct gops_gr_fecs_trace vf_gb20c_ops_gr_fecs_trace = {
...
static const struct gops_gr_init vf_gb20c_ops_gr_init = {
...
static const struct gops_gr_intr vf_gb20c_ops_gr_intr = {
...
static const struct gops_gr vf_gb20c_ops_gr = {
...
static const struct gops_nvenc vf_gb20c_ops_nvenc = {
...
static const struct gops_ofa vf_gb20c_ops_ofa = {
...
static const struct gops_nvdec vf_gb20c_ops_nvdec = {
...
static const struct gops_nvjpg vf_gb20c_ops_nvjpg = {
...
static const struct gops_class vf_gb20c_ops_gpu_class = {
...
static const struct gops_fb_intr vf_gb20c_ops_fb_intr = {
...
static const struct gops_fb vf_gb20c_ops_fb = {
...
static const struct gops_cg vf_gb20c_ops_cg = {
...
static const struct gops_engine vf_gb20c_ops_engine = {
	.is_fault_engine_subid_gpc = gv11b_is_fault_engine_subid_gpc,
	.init_ce_info = gp10b_engine_init_ce_info,
};

static const struct gops_pbdma vf_gb20c_ops_pbdma = {
	.setup_sw = NULL,
	.cleanup_sw = NULL,
	.setup_hw = NULL,
	.intr_enable = NULL,
...
static const struct gops_sync_syncpt vf_gb20c_ops_sync_syncpt = {
...
static const struct gops_sync_sema vf_gb20c_ops_sync_sema = {
...
static const struct gops_sync vf_gb20c_ops_sync = {
};

static const struct gops_engine_status vf_gb20c_ops_engine_status = {
	.read_engine_status_info = NULL,
	.dump_engine_status = NULL,
};

static const struct gops_pbdma_status vf_gb20c_ops_pbdma_status = {
	.read_pbdma_status_info = NULL,
};

static const struct gops_ramfc vf_gb20c_ops_ramfc = {
...
static const struct gops_ramin vf_gb20c_ops_ramin = {
...
static const struct gops_runlist vf_gb20c_ops_runlist = {
	.reschedule = NULL,
...
static const struct gops_userd vf_gb20c_ops_userd = {
...
static const struct gops_channel vf_gb20c_ops_channel = {
	...
	.get_vmid = vgpu_channel_get_vmid,
};

static const struct gops_tsg vf_gb20c_ops_tsg = {
...
static const struct gops_usermode vf_gb20c_ops_usermode = {
	.setup_hw = NULL,
...
static const struct gops_netlist vf_gb20c_ops_netlist = {
	.get_netlist_name = gb10b_netlist_get_name,
	.is_fw_defined = gb10b_netlist_is_firmware_defined,
};

static const struct gops_mm_mmu_fault vf_gb20c_ops_mm_mmu_fault = {
...
static const struct gops_mm_cache vf_gb20c_ops_mm_cache = {
...
static const struct gops_mm_gmmu vf_gb20c_ops_mm_gmmu = {
...
static const struct gops_mm vf_gb20c_ops_mm = {
...
static const struct gops_therm vf_gb20c_ops_therm = {
...
static const struct gops_pmu vf_gb20c_ops_pmu = {
	.pmu_early_init = NULL,
	.pmu_rtos_init = NULL,
...
static const struct gops_clk_arb vf_gb20c_ops_clk_arb = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_regops vf_gb20c_ops_regops = {
	...
	.get_hwpm_perfmon_register_ranges = gb20c_get_hwpm_perfmon_register_ranges,
	.get_hwpm_router_register_ranges = gb20c_get_hwpm_router_register_ranges,
...
static const struct gops_mc vf_gb20c_ops_mc = {
...
static const struct gops_debug vf_gb20c_ops_debug = {
	.show_dump = NULL,
};

#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_debugger vf_gb20c_ops_debugger = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_perf vf_gb20c_ops_perf = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_perfbuf vf_gb20c_ops_perfbuf = {
...
#ifdef CONFIG_NVGPU_PROFILER
static const struct gops_pm_reservation vf_gb20c_ops_pm_reservation = {
...
#ifdef CONFIG_NVGPU_PROFILER
static const struct gops_profiler vf_gb20c_ops_profiler = {
	...
	.unbind_ccuprof = vf_gb20c_profiler_unbind_ccuprof,
};
#endif

static const struct gops_bus vf_gb20c_ops_bus = {
	.init_hw = NULL,
	.isr = NULL,
	.bar1_bind = NULL,
...
static const struct gops_ptimer vf_gb20c_ops_ptimer = {
	.isr = NULL,
...
static const struct gops_css vf_gb20c_ops_css = {
...
static const struct gops_falcon vf_gb20c_ops_falcon = {
	.falcon_sw_init = nvgpu_falcon_sw_init,
	.falcon_sw_free = nvgpu_falcon_sw_free,
};

static const struct gops_priv_ring vf_gb20c_ops_priv_ring = {
...
static const struct gops_fuse vf_gb20c_ops_fuse = {
...
static const struct gops_top vf_gb20c_ops_top = {
...
static const struct gops_grmgr vf_gb20c_ops_grmgr = {
	.init_gr_manager = nvgpu_init_gr_manager,
};

static const struct gops_fb_vab vf_gb20c_ops_fb_vab = {
	.init = NULL,
...
static const struct gops_gin vf_gb20c_ops_gin = {
	.init = gb10b_gin_init,
...
int vf_gb20c_init_hal(struct gk20a *g)
{
	struct gpu_ops *gops = &g->ops;
	struct vgpu_priv_data *priv = vgpu_get_priv_data(g);

	gops->acr = vf_gb20c_ops_acr;
#ifdef CONFIG_NVGPU_DGPU
	gops->bios = vf_gb20c_ops_bios;
#endif /* CONFIG_NVGPU_DGPU */
	gops->ltc = vf_gb20c_ops_ltc;
	gops->ltc.intr = vf_gb20c_ops_ltc_intr;
#ifdef CONFIG_NVGPU_COMPRESSION
	gops->cbc = vf_gb20c_ops_cbc;
#endif
	gops->ce = vf_gb20c_ops_ce;
	gops->gr = vf_gb20c_ops_gr;
	gops->gr.ctxsw_prog = vf_gb20c_ops_gr_ctxsw_prog;
	gops->gr.config = vf_gb20c_ops_gr_config;
	gops->gr.setup = vf_gb20c_ops_gr_setup;
#ifdef CONFIG_NVGPU_GRAPHICS
	gops->gr.zbc = vf_gb20c_ops_gr_zbc;
	gops->gr.zcull = vf_gb20c_ops_gr_zcull;
#endif /* CONFIG_NVGPU_GRAPHICS */
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->gr.hwpm_map = vf_gb20c_ops_gr_hwpm_map;
#endif
	gops->gr.falcon = vf_gb20c_ops_gr_falcon;
#ifdef CONFIG_NVGPU_FECS_TRACE
	gops->gr.fecs_trace = vf_gb20c_ops_gr_fecs_trace;
#endif /* CONFIG_NVGPU_FECS_TRACE */
	gops->gr.init = vf_gb20c_ops_gr_init;
	gops->gr.intr = vf_gb20c_ops_gr_intr;
	gops->gpu_class = vf_gb20c_ops_gpu_class;
	gops->fb = vf_gb20c_ops_fb;
	gops->fb.intr = vf_gb20c_ops_fb_intr;
	gops->fb.vab = vf_gb20c_ops_fb_vab;
	gops->nvenc = vf_gb20c_ops_nvenc;
	gops->ofa = vf_gb20c_ops_ofa;
	gops->nvdec = vf_gb20c_ops_nvdec;
	gops->nvjpg = vf_gb20c_ops_nvjpg;
	gops->cg = vf_gb20c_ops_cg;
	gops->fifo = vf_gb20c_ops_fifo;
	gops->engine = vf_gb20c_ops_engine;
	gops->pbdma = vf_gb20c_ops_pbdma;
	gops->sync = vf_gb20c_ops_sync;
#ifdef CONFIG_TEGRA_GK20A_NVHOST
	gops->sync.syncpt = vf_gb20c_ops_sync_syncpt;
#endif /* CONFIG_TEGRA_GK20A_NVHOST */
#if defined(CONFIG_NVGPU_KERNEL_MODE_SUBMIT) && \
	defined(CONFIG_NVGPU_SW_SEMAPHORE)
	gops->sync.sema = vf_gb20c_ops_sync_sema;
#endif
	gops->engine_status = vf_gb20c_ops_engine_status;
	gops->pbdma_status = vf_gb20c_ops_pbdma_status;
	gops->ramfc = vf_gb20c_ops_ramfc;
	gops->ramin = vf_gb20c_ops_ramin;
	gops->runlist = vf_gb20c_ops_runlist;
	gops->userd = vf_gb20c_ops_userd;
	gops->channel = vf_gb20c_ops_channel;
	gops->tsg = vf_gb20c_ops_tsg;
	gops->usermode = vf_gb20c_ops_usermode;
	gops->netlist = vf_gb20c_ops_netlist;
	gops->mm = vf_gb20c_ops_mm;
	gops->mm.mmu_fault = vf_gb20c_ops_mm_mmu_fault;
	gops->mm.cache = vf_gb20c_ops_mm_cache;
	gops->mm.gmmu = vf_gb20c_ops_mm_gmmu;
	gops->therm = vf_gb20c_ops_therm;
#ifdef CONFIG_NVGPU_LS_PMU
	gops->pmu = vf_gb20c_ops_pmu;
#endif
#ifdef CONFIG_NVGPU_CLK_ARB
	gops->clk_arb = vf_gb20c_ops_clk_arb;
#endif
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->regops = vf_gb20c_ops_regops;
#endif
	gops->mc = vf_gb20c_ops_mc;
	gops->debug = vf_gb20c_ops_debug;
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->debugger = vf_gb20c_ops_debugger;
	gops->perf = vf_gb20c_ops_perf;
	gops->perfbuf = vf_gb20c_ops_perfbuf;
#endif
#ifdef CONFIG_NVGPU_PROFILER
	gops->pm_reservation = vf_gb20c_ops_pm_reservation;
	gops->profiler = vf_gb20c_ops_profiler;
#endif
	gops->bus = vf_gb20c_ops_bus;
	gops->ptimer = vf_gb20c_ops_ptimer;
#if defined(CONFIG_NVGPU_CYCLESTATS)
	gops->css = vf_gb20c_ops_css;
#endif
	gops->falcon = vf_gb20c_ops_falcon;
	gops->priv_ring = vf_gb20c_ops_priv_ring;
	gops->fuse = vf_gb20c_ops_fuse;
	gops->top = vf_gb20c_ops_top;
	gops->grmgr = vf_gb20c_ops_grmgr;
	gops->gin = vf_gb20c_ops_gin;

	/* Lone functions */
	gops->chip_init_gpu_characteristics = vf_gb20c_init_gpu_characteristics;
