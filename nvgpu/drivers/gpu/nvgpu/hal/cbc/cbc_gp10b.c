...
int gp10b_cbc_alloc_comptags(struct gk20a *g, struct nvgpu_cbc *cbc)
{
	...
	compbit_backing_size =
		NVGPU_ALIGN(nvgpu_safe_mult_u32(max_comptag_lines, gobs_per_comptagline_per_slice),
			    nvgpu_ltc_get_cacheline_size(g));
	compbit_backing_size =
		NVGPU_ALIGN(nvgpu_safe_mult_u32(nvgpu_safe_mult_u32(compbit_backing_size,
