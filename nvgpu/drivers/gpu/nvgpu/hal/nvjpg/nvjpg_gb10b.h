...
#ifndef NVGPU_NVJPG_GB10B_H
#define NVGPU_NVJPG_GB10B_H

#include <nvgpu/types.h>

#define GB10B_NVJPG_RISCV_EB_UCODE_IMAGE            "g_nvjpg_t264_riscv_eb_image_debug_encrypted.bin"
#define GB10B_NVJPG_RISCV_EB_UCODE_PROD_IMAGE       "g_nvjpg_t264_riscv_eb_image_prod_encrypted.bin"
#define GB10B_NVJPG_RISCV_EB_UCODE_DESC             "g_nvjpg_t264_riscv_eb_desc.bin"
#define GB10B_NVJPG_RISCV_EB_UCODE_PKC_SIG          "g_nvjpg_t264_riscv_eb_pkc_ls_sig.bin"
#define GB10B_NVJPG_RISCV_EB_UCODE_LSB_PKC_SIG      "g_nvjpg_t264_riscv_eb_pkc_ls_lsb_header.bin"
