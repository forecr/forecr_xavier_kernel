...
#include "hal/class/class_gb20c.h"
...
#include "hal/regops/regops_gb20c.h"
#include "hal/regops/user_access_map_gb20c.h"
#include "hal/regops/allowlist_gb10b.h"
#include "hal/regops/allowlist_gb20c.h"
#include "hal/regops/allowlist_auto_generated_gb10b.h"
#include "hal/regops/allowlist_auto_generated_gb20c.h"
#endif
...
#include "hal/fifo/runlist_ram_gb20c.h"
...
#include "hal/fifo/runlist_fifo_gb20c.h"
#include "hal/fifo/runlist_ga10b.h"
#include "hal/fifo/runlist_gb20c.h"
...
#include "hal/gr/zbc/zbc_gb20c.h"
...
#include "hal/gr/init/gr_init_gb20c.h"
...
#include "hal/gr/intr/gr_intr_gb20c.h"
#ifdef CONFIG_NVGPU_DEBUGGER
#include "hal/gr/hwpm_map/hwpm_map_gv100.h"
#include "hal/gr/hwpm_map/hwpm_map_ga10b.h"
#include "hal/gr/hwpm_map/hwpm_map_gb10b.h"
#include "hal/gr/hwpm_map/hwpm_map_gb20c.h"
#endif
...
#include "hal/pmu/pmu_gb20c.h"
#include "hal/gsp/gsp_ga10b.h"
#include "hal/gsp/gsp_gb10b.h"
#include "hal/gsp/gsp_gb20c.h"
...
#include "hal/nvenc/nvenc_gb20c.h"
#include "hal/ofa/ofa_gb20c.h"
#include "hal/nvdec/nvdec_gb20c.h"
...
#include "hal/grmgr/grmgr_gb20c.h"
#include "hal/power_features/cg/gb20c_gating_reglist.h"
...
#include "hal/fuse/fuse_gb20c.h"

#include "hal/lrc/lrc_gb10b.h"

#include "hal_gb20c.h"

static int gb20c_init_gpu_characteristics(struct gk20a *g)
{
	int err;
...
static const struct gops_acr gb20c_ops_acr = {
	.acr_init = nvgpu_acr_init,
	.acr_construct_execute = nvgpu_acr_construct_execute,
};

static const struct gops_func gb20c_ops_func = {
	.get_full_phys_offset = ga10b_func_get_full_phys_offset,
};

static const struct gops_bios gb20c_ops_bios = {
	.bios_sw_init = nvgpu_bios_sw_init,
};

static const struct gops_ecc gb20c_ops_ecc = {
...
static const struct gops_ltc_intr gb20c_ops_ltc_intr = {
...
static const struct gops_ltc gb20c_ops_ltc = {
...
#ifdef CONFIG_NVGPU_NON_FUSA
	.get_ltcs_ltss_tstg_cfg1_active_sets = gb20c_ltcs_ltss_tstg_cfg1_active_sets,
#endif /* CONFIG_NVGPU_NON_FUSA */
};

#ifdef CONFIG_NVGPU_COMPRESSION
static const struct gops_cbc gb20c_ops_cbc = {
	.cbc_init_support = gb10b_cbc_init_support,
	.cbc_remove_support = gb10b_cbc_remove_support,
};
#endif

static const struct gops_ce gb20c_ops_ce = {
	...
	.init_pce2lce_configs = gb20c_ce_init_pce2lce_configs,
	.init_grce_configs = gb20c_ce_init_grce_configs,
	.set_engine_reset = gb10b_ce_set_engine_reset,
	.reset = nvgpu_ce_reset,
	.grce_config_size = gb20c_grce_config_size,
};

static const struct gops_gr_ecc gb20c_ops_gr_ecc = {
...
static const struct gops_gr_ctxsw_prog gb20c_ops_gr_ctxsw_prog = {
...
static const struct gops_gr_config gb20c_ops_gr_config = {
...
#ifdef CONFIG_NVGPU_FECS_TRACE
static const struct gops_gr_fecs_trace gb20c_ops_gr_fecs_trace = {
...
static const struct gops_gr_setup gb20c_ops_gr_setup = {
...
#ifdef CONFIG_NVGPU_GRAPHICS
static const struct gops_gr_zbc gb20c_ops_gr_zbc = {
	.add_color = gb20c_gr_zbc_add_color,
	...
	.get_gr_pri_gpcs_rops_crop_zbc_index_address_max = gb20c_gr_pri_gpcs_rops_crop_zbc_index_address_max,
};
#endif

#ifdef CONFIG_NVGPU_GRAPHICS
static const struct gops_gr_zcull gb20c_ops_gr_zcull = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_gr_hwpm_map gb20c_ops_gr_hwpm_map = {
	...
	.add_reg_in_fecs_to_map = gb20c_hwpm_map_add_reg_in_fecs_to_map,
	.add_reg_in_gpccs_to_map = ga10b_hwpm_map_add_reg_in_gpccs_to_map,
	.add_hes_reg_to_map = gb20c_hwpm_map_add_hes_reg_to_map,
	.add_padding_for_dtdtpc_support = gb20c_hwpm_map_add_padding_for_dtdtpc_support,
	.get_cpc_info = gb20c_hwpm_map_get_cpc_info,
};
#endif

static const struct gops_gr_init gb20c_ops_gr_init = {
...
#ifdef CONFIG_NVGPU_SET_FALCON_ACCESS_MAP
	.get_access_map = gb20c_gr_init_get_access_map,
#endif
	...
	.get_min_gpm_fifo_depth = gb20c_gr_init_get_min_gpm_fifo_depth,
	.get_bundle_cb_token_limit = gb20c_gr_init_get_bundle_cb_token_limit,
	.get_attrib_cb_default_size = gb20c_gr_init_get_attrib_cb_default_size,
	...
	.get_gpcs_rops_crop_debug1_off = gb20c_gpcs_rops_crop_debug1_off,
#endif /* CONFIG_NVGPU_GRAPHICS */
#ifdef CONFIG_NVGPU_GFXP
	...
	.get_attrib_cb_gfxp_default_size = gb20c_gr_init_get_attrib_cb_gfxp_size,
	.get_attrib_cb_gfxp_size = gb20c_gr_init_get_attrib_cb_gfxp_size,
	.gfxp_wfi_timeout = gv11b_gr_init_commit_gfxp_wfi_timeout,
	.get_ctx_spill_size = gb20c_gr_init_get_ctx_spill_size,
...
#endif
	.is_cwd_gpc_tpc_id_removed = gb20c_is_cwd_gpc_tpc_id_removed,
#endif /* CONFIG_NVGPU_GFXP */
};

static const struct gops_gr_intr gb20c_ops_gr_intr = {
	.handle_fecs_error = gv11b_gr_intr_handle_fecs_error,
	.is_valid_sw_method = gb10b_gr_intr_is_valid_sw_method,
	.handle_sw_method = gb20c_gr_intr_handle_sw_method,
	...
	.get_gpc0_rop0_crop_hww_esr_offset = gb20c_gpc0_rop0_crop_hww_esr_offset,
	.handle_gpc_rrh_hww = ga10b_gr_intr_handle_gpc_rrh_hww,
	.get_gpc0_rop0_rrh_status_offset = gb20c_gpc0_rop0_rrh_status_offset,
	...
	.enable_gpc_crop_hww = gb20c_gr_intr_enable_gpc_crop_hww,
...
static const struct gops_gr_falcon gb20c_ops_gr_falcon = {
...
static const struct gops_gr gb20c_ops_gr = {
	...
	.set_tex_in_dbg = gb10b_gr_intr_set_tex_in_dbg,
	...
	.set_mmu_debug_mode = gb20c_gr_set_mmu_debug_mode,
...
static const struct gops_nvenc gb20c_ops_nvenc = {
	...
	.get_nvenc_fw = nvgpu_gb20c_nvenc_fw,
};

static const struct gops_ofa gb20c_ops_ofa = {
	...
	.get_ofa_fw = nvgpu_gb20c_ofa_fw,
};

static const struct gops_nvdec gb20c_ops_nvdec = {
	...
	.multimedia_alloc_ctx = nvgpu_multimedia_setup_ctx,
	.multimedia_free_ctx = nvgpu_multimedia_free_ctx,
	.get_nvdec_fw = nvgpu_gb20c_nvdec_fw,
};

static const struct gops_nvjpg gb20c_ops_nvjpg = {
	.base_addr = NULL,
	.falcon2_base_addr = NULL,
	.setup_boot_config = NULL,
	.halt_engine = NULL,
	.reset_eng = NULL,
	...
	.multimedia_alloc_ctx = nvgpu_multimedia_setup_ctx,
	.multimedia_free_ctx = nvgpu_multimedia_free_ctx,
	.get_nvjpg_fw = NULL, /* No NVJPG in T256 */
	.is_nvjpg_not_supported = true,
};

static const struct gops_class gb20c_ops_gpu_class = {
	.is_valid = gb20c_class_is_valid,
	.is_valid_compute = gb10b_class_is_valid_compute,
#ifdef CONFIG_NVGPU_GRAPHICS
	.is_valid_gfx = gb10b_class_is_valid_gfx,
#endif
	.is_valid_multimedia = gb20c_class_is_valid_multimedia,
	.is_valid_nvenc = gb20c_class_is_valid_nvenc,
	.is_valid_ofa = gb20c_class_is_valid_ofa,
	.is_valid_nvdec = gb20c_class_is_valid_nvdec,
	.is_valid_nvjpg = NULL,
};

static const struct gops_fb_ecc gb20c_ops_fb_ecc = {
	.ecc_counter_init = ga10b_fb_ecc_init,
	.ecc_counter_free = ga10b_fb_ecc_free,
	.l2tlb_error_mask = ga10b_fb_ecc_l2tlb_error_mask,
};

static const struct gops_fb_intr gb20c_ops_fb_intr = {
...
#ifdef CONFIG_NVGPU_HAL_NON_FUSA
static const struct gops_fb_vab gb20c_ops_fb_vab = {
...
static const struct gops_xtl gb20c_ops_xtl = {
	.init_hw = gb10b_xtl_ep_init_hw,
};

static const struct gops_fb gb20c_ops_fb = {
...
static const struct gops_cg gb20c_ops_cg = {
	.slcg_bus_load_gating_prod = gb20c_slcg_bus_load_gating_prod,
	.slcg_ce2_load_gating_prod = gb20c_slcg_ce2_load_gating_prod,
	.slcg_chiplet_load_gating_prod = gb20c_slcg_chiplet_load_gating_prod,
	.slcg_fb_load_gating_prod = gb20c_slcg_fb_load_gating_prod,
	.slcg_fifo_load_gating_prod = NULL,
	.slcg_runlist_load_gating_prod = gb20c_slcg_runlist_load_gating_prod,
	.slcg_gr_load_gating_prod = gb20c_slcg_gr_load_gating_prod,
	.slcg_ltc_load_gating_prod = gb20c_slcg_ltc_load_gating_prod,
	.slcg_perf_load_gating_prod = gb20c_slcg_perf_load_gating_prod,
	.slcg_priring_load_gating_prod = gb20c_slcg_priring_load_gating_prod,
	.slcg_rs_ctrl_fbp_load_gating_prod =
				gb20c_slcg_rs_ctrl_fbp_load_gating_prod,
	.slcg_rs_ctrl_gpc_load_gating_prod =
				gb20c_slcg_rs_ctrl_gpc_load_gating_prod,
	.slcg_rs_ctrl_sys_load_gating_prod =
				gb20c_slcg_rs_ctrl_sys_load_gating_prod,
	.slcg_rs_fbp_load_gating_prod = gb20c_slcg_rs_fbp_load_gating_prod,
	.slcg_rs_gpc_load_gating_prod = gb20c_slcg_rs_gpc_load_gating_prod,
	.slcg_rs_sys_load_gating_prod = gb20c_slcg_rs_sys_load_gating_prod,
	.slcg_pmu_load_gating_prod = gb20c_slcg_pmu_load_gating_prod,
	.slcg_therm_load_gating_prod = NULL,
	.slcg_xbar_load_gating_prod = gb20c_slcg_xbar_load_gating_prod,
	.slcg_hshub_load_gating_prod = NULL,
	.slcg_fbhub_load_gating_prod = gb20c_slcg_fbhub_load_gating_prod,
	.slcg_timer_load_gating_prod = gb20c_slcg_timer_load_gating_prod,
	.slcg_ctrl_load_gating_prod = gb20c_slcg_ctrl_load_gating_prod,
	.slcg_gsp_load_gating_prod = gb20c_slcg_gsp_load_gating_prod,
	.slcg_xal_ep_load_gating_prod = gb20c_slcg_xal_ep_load_gating_prod,
	.slcg_nvenc_load_gating_prod = gb20c_slcg_nvenc_load_gating_prod,
	.slcg_ofa_load_gating_prod = gb20c_slcg_ofa_load_gating_prod,
	.slcg_nvdec_load_gating_prod = gb20c_slcg_nvdec_load_gating_prod,
	.slcg_nvjpg_load_gating_prod = NULL,
	.blcg_bus_load_gating_prod = gb20c_blcg_bus_load_gating_prod,
	.blcg_ce_load_gating_prod = gb20c_blcg_ce_load_gating_prod,
	.blcg_fb_load_gating_prod = gb20c_blcg_fb_load_gating_prod,
	.blcg_fifo_load_gating_prod = NULL,
	.blcg_runlist_load_gating_prod = gb20c_blcg_runlist_load_gating_prod,
	.blcg_gr_load_gating_prod = gb20c_blcg_gr_load_gating_prod,
	.blcg_ltc_load_gating_prod = gb20c_blcg_ltc_load_gating_prod,
	.blcg_pmu_load_gating_prod = gb20c_blcg_pmu_load_gating_prod,
	.blcg_xbar_load_gating_prod = gb20c_blcg_xbar_load_gating_prod,
	.blcg_hshub_load_gating_prod = NULL,
	.blcg_fbhub_load_gating_prod = gb20c_blcg_fbhub_load_gating_prod,
	.blcg_xal_ep_load_gating_prod = gb20c_blcg_xal_ep_load_gating_prod,
	.blcg_ctrl_load_gating_prod = gb20c_blcg_ctrl_load_gating_prod,
	.blcg_nvenc_load_gating_prod = gb20c_blcg_nvenc_load_gating_prod,
	.blcg_ofa_load_gating_prod = gb20c_blcg_ofa_load_gating_prod,
	.blcg_nvdec_load_gating_prod = gb20c_blcg_nvdec_load_gating_prod,
	.blcg_nvjpg_load_gating_prod = NULL,
	.elcg_ce_load_gating_prod = gb20c_elcg_ce_load_gating_prod,
};

static const struct gops_fifo gb20c_ops_fifo = {
	...
	.runlist_intr_0_en_clear_tree = gb20c_runlist_intr_0_en_clear_tree,
	.runlist_intr_0_en_set_tree = gb20c_runlist_intr_0_en_set_tree,
	.handle_sched_error = NULL,
	.ctxsw_timeout_enable = ga10b_fifo_ctxsw_timeout_enable,
	.ctxsw_timeout_config = gb20c_fifo_ctxsw_timeout_config,
	.ctxsw_timeout_config_size_1 = gb20c_ctxsw_timeout_config_size_1,
	...
	.runlist_intr_0 = gb20c_runlist_intr_0,
	.runlist_intr_ctrl = gb20c_runlist_intr_ctrl,
	.get_runlist_intr_0_mask = gb20c_runlist_intr_0_mask,
	.get_runlist_intr_0_recover_mask = gb20c_runlist_intr_0_recover_mask,
	.get_runlist_intr_0_recover_unmask = gb20c_runlist_intr_0_recover_unmask,
	.get_runlist_intr_0_ctxsw_timeout_mask = gb20c_runlist_intr_0_ctxsw_timeout_mask,
	.get_runlist_intr_bad_tsg = gb20c_runlist_intr_bad_tsg,
	.get_runlist_intr_retrigger_reg_off = gb20c_runlist_intr_retrigger_reg_off,
	.get_runlist_preempt_reg = gb20c_runlist_preempt_reg,
	.get_rleng_ctxsw_timeout_info_reg_off = gb20c_rleng_ctxsw_timeout_info_reg_off,
};

static const struct gops_engine gb20c_ops_engine = {
	.is_fault_engine_subid_gpc = gv11b_is_fault_engine_subid_gpc,
	.init_ce_info = gp10b_engine_init_ce_info,
};

static const struct gops_pbdma gb20c_ops_pbdma = {
	.setup_sw = nvgpu_pbdma_setup_sw,
	.cleanup_sw = nvgpu_pbdma_cleanup_sw,
	.setup_hw = NULL,
	.intr_enable = gb20c_pbdma_intr_enable,
	/* fix_ga10b_gb10b_missing */
	...
	.reset_method = gb20c_pbdma_reset_method,
	.acquire_val = NULL,
	.get_signature = gp10b_pbdma_get_signature,
#ifdef CONFIG_NVGPU_HAL_NON_FUSA
	.syncpt_debug_dump = NULL,
	.dump_status = gb20c_pbdma_dump_status,
#endif
	...
	.dump_intr_0 = gb20c_pbdma_dump_intr_0,
	.set_clear_intr_offsets = NULL,
	.read_data = gb20c_pbdma_read_data,
	.reset_header = gb20c_pbdma_reset_header,
	...
	.get_fc_target = gb20c_pbdma_get_fc_target,
	...
	.get_config_auth_level_privileged = gb20c_pbdma_get_config_auth_level_privileged,
	.set_channel_info_veid = NULL,
	.set_channel_info_chid = NULL,
	.set_intr_notify = gb10b_pbdma_set_intr_notify,
	.is_sw_method_subch = gb20c_pbdma_is_sw_method_subch,
	.report_error = gb10b_pbdma_report_error,
	.config_userd_writeback_enable = NULL,
	.get_mmu_fault_id = gb20c_pbdma_get_mmu_fault_id,
	.get_num_of_pbdmas = gb20c_pbdma_get_num_of_pbdmas,
	.intr_0_reg_addr = gb20c_intr_0_reg_addr,
	.intr_1_reg_addr = gb20c_intr_1_reg_addr,
	.hce_dbg0_reg_addr = gb20c_hce_dbg0_reg_addr,
	.hce_dbg1_reg_addr = gb20c_hce_dbg1_reg_addr,
};

#ifdef CONFIG_TEGRA_GK20A_NVHOST
static const struct gops_sync_syncpt gb20c_ops_sync_syncpt = {
...
static const struct gops_sync_sema gb20c_ops_sync_sema = {
...
static const struct gops_sync gb20c_ops_sync = {
};

static const struct gops_engine_status gb20c_ops_engine_status = {
	...
	.get_rleng_status0_reg_off = gb20c_rleng_status0_reg_off,
	.get_rleng_status1_reg_off = gb20c_rleng_status1_reg_off,
};

static const struct gops_pbdma_status gb20c_ops_pbdma_status = {
	.read_pbdma_status_info = ga10b_read_pbdma_status_info,
	.pbdma_status_sched_reg_addr = gb20c_pbdma_status_sched_reg_addr,
	.pbdma_channel_reg_addr = gb20c_pbdma_channel_reg_addr,
	.pbdma_next_channel_reg_addr = gb20c_pbdma_next_channel_reg_addr,
};

static const struct gops_ramfc gb20c_ops_ramfc = {
	...
	.get_syncpt = NULL,
	.set_syncpt = NULL,
	.set_channel_info = NULL,
};

static const struct gops_ramin gb20c_ops_ramin = {
...
static const struct gops_runlist gb20c_ops_runlist = {
	...
	.get_ch_entry_veid = gb20c_runlist_get_ch_entry_veid,
	.hw_submit = gb20c_runlist_hw_submit,
	.check_pending = gb20c_runlist_check_pending,
	.write_state = ga10b_runlist_write_state,
	.get_runlist_id = gb20c_runlist_get_runlist_id,
	.get_runlist_aperture = ga10b_get_runlist_aperture,
	.get_engine_id_from_rleng_id = gb20c_runlist_get_engine_id_from_rleng_id,
	.get_chram_bar0_offset = gb20c_runlist_get_chram_bar0_offset,
	.get_pbdma_info = gb20c_runlist_get_pbdma_info,
	.get_engine_intr_id = NULL,
	.init_enginfo = nvgpu_runlist_init_enginfo,
	.get_tsg_max_timeslice = gv11b_runlist_max_timeslice,
	.get_esched_fb_thread_id = gb20c_runlist_get_esched_fb_thread_id,
	.get_max_channels_per_tsg = gv11b_runlist_get_max_channels_per_tsg,
	.get_sched_disable_reg_off = gb20c_sched_disable_reg_off,
	.get_chan_userd_ptr_hi = gb20c_chan_userd_ptr_hi,
	.get_virtual_channel_cfg_off = gb20c_virtual_channel_cfg_off,
};

static const struct gops_userd gb20c_ops_userd = {
...
static const struct gops_channel gb20c_ops_channel = {
...
static const struct gops_tsg gb20c_ops_tsg = {
	...
	.bind_channel = NULL,
	.bind_channel_eng_method_buffers = gb20c_tsg_bind_channel_eng_method_buffers,
	.unbind_channel = NULL,
...
static const struct gops_usermode gb20c_ops_usermode = {
	...
	.doorbell_token = gb20c_usermode_doorbell_token,
};

static const struct gops_netlist gb20c_ops_netlist = {
	.get_netlist_name = gb20c_netlist_get_name,
	.is_fw_defined = gb20c_netlist_is_firmware_defined,
	.get_fecs_pkc_name = gb20c_fecs_pkc_get_name,
	.get_gpccs_pkc_name = gb20c_gpccs_pkc_get_name,
	.get_fecs_desc_name = gb20c_fecs_desc_get_name,
	.get_gpccs_desc_name = gb20c_gpccs_desc_get_name,
};

static const struct gops_mm_mmu_fault gb20c_ops_mm_mmu_fault = {
...
static const struct gops_mm_cache gb20c_ops_mm_cache = {
...
static const struct gops_mm_gmmu gb20c_ops_mm_gmmu = {
...
static const struct gops_mm gb20c_ops_mm = {
...
static const struct gops_therm gb20c_ops_therm = {
	/*
...
static const struct gops_gsp gb20c_ops_gsp = {
	...
	/* interrupt */
	.enable_irq = gb20c_gsp_enable_irq,
	...
	.gsp_queue_type = gb20c_gsp_flcn_queue_type,

	.falcon_setup_boot_config = NULL,
};

static const struct gops_pmu gb20c_ops_pmu = {
	...
	.pmu_elcg_sub_feature_id_to_engine_id =
			gb20c_pmu_elcg_sub_feature_id_to_engine_id,
	.pmu_elcg_all_engine_mask = gb20c_pmu_elcg_all_engine_mask,
	.pmu_elcg_mm_engine_mask = gb20c_pmu_elcg_mm_engine_mask,
	.pmu_fgpg_all_engine_mask = gb20c_pmu_fgpg_get_all_engine_mask,
#endif
	.get_amap_extmem2_start = gb10b_get_amap_extmem2_start,
	.is_perf_cf_supported = true,
};

#ifdef CONFIG_NVGPU_CLK_ARB
static const struct gops_clk_arb gb20c_ops_clk_arb = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_regops gb20c_ops_regops = {
	.exec_regops = exec_regops_gk20a,
	.get_global_whitelist_ranges = gb20c_get_global_allowlist_ranges,
	.get_global_whitelist_ranges_count = gb20c_get_global_allowlist_ranges_count,
	.get_context_whitelist_ranges = gb20c_get_context_allowlist_ranges,
	.get_context_whitelist_ranges_count = gb20c_get_context_allowlist_ranges_count,
	.get_runcontrol_whitelist = gb20c_get_runcontrol_allowlist,
	.get_runcontrol_whitelist_count = gb20c_get_runcontrol_allowlist_count,
	.get_hwpm_router_register_stride = gb20c_get_hwpm_router_register_stride,
	.get_hwpm_perfmon_register_stride = gb20c_get_hwpm_perfmon_register_stride,
	.get_hwpm_pma_channel_register_stride = gb20c_get_hwpm_pma_channel_register_stride,
	.get_hwpm_pma_trigger_register_stride = gb20c_get_hwpm_pma_trigger_register_stride,
	.get_smpc_register_stride = gb20c_get_smpc_register_stride,
	.get_cau_register_stride = gb20c_get_cau_register_stride,
	.get_hwpm_perfmon_register_offset_allowlist =
		gb20c_get_hwpm_perfmon_register_offset_allowlist,
	.get_hwpm_router_register_offset_allowlist =
		gb20c_get_hwpm_router_register_offset_allowlist,
	.get_hwpm_pma_channel_register_offset_allowlist =
		gb20c_get_hwpm_pma_channel_register_offset_allowlist,
	.get_hwpm_pma_trigger_register_offset_allowlist =
		gb20c_get_hwpm_pma_trigger_register_offset_allowlist,
	.get_smpc_register_offset_allowlist = gb20c_get_smpc_register_offset_allowlist,
	.get_cau_register_offset_allowlist = gb20c_get_cau_register_offset_allowlist,
	.get_hes_register_offset_allowlist = gb20c_get_hes_register_offset_allowlist,
	.get_ccuprof_register_offset_allowlist = gb20c_get_ccuprof_register_offset_allowlist,
	.get_hwpm_pma_channel_register_ranges = gb20c_get_hwpm_pma_channel_register_ranges,
	.get_hwpm_pc_sampler_register_ranges = gb20c_get_hwpm_pc_sampler_register_ranges,
	.get_hwpm_pma_trigger_register_ranges = gb20c_get_hwpm_pma_trigger_register_ranges,
	.get_smpc_register_ranges = gb20c_get_smpc_register_ranges,
	.get_cau_register_ranges = gb20c_get_cau_register_ranges,
	.get_hwpm_perfmux_register_ranges = gb20c_get_hwpm_perfmux_register_ranges,
	.get_sys_misc_device_register_ranges = gb20c_get_sys_misc_device_register_ranges,
	.get_hes_register_ranges = gb20c_get_hes_register_ranges,
	.get_hep_register_ranges = gb20c_get_hep_register_ranges,
	.get_hwpm_mm_register_ranges = gb20c_get_hwpm_mm_register_ranges,
	.get_hwpm_perfmon_gpc_reg_base = gb20c_get_hwpm_perfmon_gpc_reg_base,
	.get_hwpm_perfmon_fbp_reg_base = gb20c_get_hwpm_perfmon_fbp_reg_base,
	.get_hwpm_perfmon_sys_reg_base = gb20c_get_hwpm_perfmon_sys_reg_base,
	.get_hwpm_perfmon_gpc_reg_stride = gb20c_get_hwpm_perfmon_gpc_reg_stride,
	.get_hwpm_router_gpc_reg_base = gb20c_get_hwpm_router_gpc_reg_base,
	.get_hwpm_router_fbp_reg_base = gb20c_get_hwpm_router_fbp_reg_base,
	.get_hwpm_router_sys_reg_base = gb20c_get_hwpm_router_sys_reg_base,
	.get_hwpm_router_gpc_reg_stride = gb20c_get_hwpm_router_gpc_reg_stride,
	.get_hwpm_pma_trigger_reg_base = gb20c_get_hwpm_pma_trigger_reg_base,
	.get_hwpm_pmasys_command_slice_stride = gb20c_get_hwpm_pmasys_command_slice_stride,
	.get_hwpm_gpc0_tpc0_cau_base = gb20c_get_hwpm_gpc0_tpc0_cau_base,
	.get_hwpm_tpc_cau_range_stride = gb20c_get_hwpm_tpc_cau_range_stride,
	.get_hwpm_pma_channel_cblock_reg_stride = gb20c_get_hwpm_pma_channel_cblock_reg_stride,
	.get_hwpm_pma_channel_reg_base = gb20c_get_hwpm_pma_channel_reg_base,
	.get_hwpm_hem_sys0_base = gb20c_get_hwpm_hem_sys0_base,
	.get_hwpm_hem_sys0_stride = gb20c_get_hwpm_hem_sys0_stride,
	.get_hwpm_perf_pmasys_reg_base = gb20c_get_hwpm_perf_pmasys_reg_base,
	.get_hwpm_perf_ccuprof_units_per_gpc = gb20c_get_hwpm_perf_ccuprof_units_per_gpc,
	.get_hwpm_perf_ccuprof_units_per_fbp = gb20c_get_hwpm_perf_ccuprof_units_per_fbp,
	.get_hwpm_perf_ccuprof_gpc0_reg_base = gb20c_get_hwpm_perf_ccuprof_gpc0_reg_base,
	.get_hwpm_perf_ccuprof_gpcs_reg_base = gb20c_get_hwpm_perf_ccuprof_gpcs_reg_base,
	.get_hwpm_perf_ccuprof_fbp0_reg_base = gb20c_get_hwpm_perf_ccuprof_fbp0_reg_base,
	.get_hwpm_perf_ccuprof_fbps_reg_base = gb20c_get_hwpm_perf_ccuprof_fbps_reg_base,
	.get_hwpm_perf_ccuprof_gpc_reg_stride = gb20c_get_hwpm_perf_ccuprof_gpc_reg_stride,
	.get_hwpm_perf_ccuprof_fbp_reg_stride = gb20c_get_hwpm_perf_ccuprof_fbp_reg_stride,
	.get_hwpm_perf_ccuprof_unit_reg_stride = gb20c_get_hwpm_perf_ccuprof_unit_reg_stride,
	.get_hwpm_gpc0_tpc0_mpc_ccuprof_ulcmux_cntl0 =
						gb20c_get_hwpm_gpc0_tpc0_mpc_ccuprof_ulcmux_cntl0,
	.get_hwpm_ltc0_lts0_ccuprof_ulcmux_cntl0 = gb20c_get_hwpm_ltc0_lts0_ccuprof_ulcmux_cntl0,
	.init_reg_op_type_per_register_type = gb20c_init_reg_op_type_per_register_type,
	.get_hwpm_perfmon_user_access_register_ranges =
		gb10b_get_hwpm_perfmon_bitvector_register_ranges,
	.get_hwpm_router_user_access_register_ranges =
		gb10b_get_hwpm_router_bitvector_register_ranges,
	.get_pma_channel_user_access_register_ranges =
		gb10b_get_hwpm_pma_channel_bitvector_register_ranges,
	.get_pma_trigger_user_access_register_ranges =
		gb10b_get_hwpm_pma_trigger_bitvector_register_ranges,
	.get_smpc_user_access_register_ranges =
		gb10b_get_hwpm_smpc_bitvector_register_ranges,
	.get_cau_user_access_register_ranges =
		gb10b_get_hwpm_cau_bitvector_register_ranges,
	.get_hes_user_access_register_ranges =
		gb10b_get_hwpm_hes_bitvector_register_ranges,
	.get_ccuprof_user_access_register_ranges =
		gb20c_get_hwpm_ccuprof_bitvector_register_ranges,
	.allowlist_misc_register_ranges = gb20c_allowlist_misc_register_ranges,
};
#endif

static const struct gops_mc gb20c_ops_mc = {
...
static const struct gops_debug gb20c_ops_debug = {
	.show_dump = gk20a_debug_show_dump,
};

#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_debugger gb20c_ops_debugger = {
...
#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_perf gb20c_ops_perf = {
	...
	.get_membuf_overflow_status = gb20c_perf_get_membuf_overflow_status,
	...
	.get_pmmfbprouter_per_chiplet_offset = gb20c_perf_get_pmmfbprouter_per_chiplet_offset,
	.update_get_put = gb20c_perf_update_get_put,
	...
	.get_num_hwpm_perfmon = gb20c_perf_get_num_hwpm_perfmon,
	...
	.set_secure_config_for_ccu_prof = gb20c_perf_set_secure_config_for_ccu_prof,
	.update_sys_dg_map_status_mask = gb20c_update_sys_dg_map_status_mask,
	.update_cau_dg_map_status_mask = gb10b_update_cau_dg_map_status_mask,
	.get_pma_cblock_instance_count = gb20c_perf_get_cblock_instance_count,
	.get_pma_channel_count = gb10b_perf_get_pma_channel_count,
	.get_ctx_switched_pma_channel_count = gb20c_perf_get_ctx_switched_pma_channel_count,
	.get_pma_channels_per_cblock = gb10b_perf_get_pma_channels_per_cblock,
	.reset_pm_trigger_masks = gb20c_perf_reset_pm_trigger_masks,
	.enable_pm_trigger = gb20c_perf_enable_pm_trigger,
	.enable_hes_event_trigger = gb20c_perf_enable_hes_event_trigger,
	.enable_pma_trigger = gb20c_perf_enable_pma_trigger,
	.get_hwpm_fbp_fbpgs_ltcs_base_addr = gb20c_perf_get_hwpm_fbp_fbpgs_ltcs_base_addr,
	...
	.get_tpc_perfmon_range = gb20c_perf_get_tpc_perfmon_range,
	.get_max_num_gpc_perfmons = gb20c_perf_get_max_num_gpc_perfmons,
	.get_gpc_perfmon_stride = gb10b_perf_get_gpc_perfmon_stride,
	.get_gpc_tpc_start_dg_idx = gb20c_perf_get_gpc_tpc_start_dg_idx,
	.get_gpc_tpc_end_dg_idx = gb20c_perf_get_gpc_tpc_end_dg_idx,
	.is_perfmon_simulated = gb20c_perf_is_perfmon_simulated,
	.get_num_cwd_hems = gb20c_perf_get_num_cwd_hems,
	.update_sys_hem_cwd_dg_map_mask = gb20c_perf_update_sys_hem_cwd_dg_map_mask,
	.get_gpc_tpc0_cau0_dg_idx = gb20c_perf_get_gpc_tpc0_cau0_dg_idx,
	.get_sysrouter_channel_stride = gb20c_perf_get_sysrouter_channel_stride,
	.get_pmasys_channel_stride = gb20c_perf_get_pmasys_channel_stride,
	.get_pmasys_cmdslice_stride = gb20c_perf_get_pmasys_cmdslice_stride,
	.get_pmasys_fwd_channel_stride = gb20c_perf_get_pmasys_fwd_channel_stride,
	.get_sys_perfmon_idx_range = gb20c_perf_get_sys_perfmon_range,
	.get_sys_perfmon_stride = gb20c_perf_get_sys_perfmon_stride,
	.supports_extended_b2cc = gb20c_perf_supports_extended_b2cc,
	.write_hwpm_register = gb20c_perf_write_hwpm_register,
	.read_hwpm_register = gb20c_perf_read_hwpm_register,
	.disable_ccuprof = gb20c_perf_disable_ccuprof,
	.pma_stream_preparation = gb10b_perf_pma_stream_preparation,
};
#endif

#ifdef CONFIG_NVGPU_DEBUGGER
static const struct gops_perfbuf gb20c_ops_perfbuf = {
...
static const struct gops_pm_reservation gb20c_ops_pm_reservation = {
...
#ifdef CONFIG_NVGPU_PROFILER
static const struct gops_profiler gb20c_ops_profiler = {
	...
	.unbind_ccuprof = nvgpu_profiler_unbind_ccuprof,
	...
	.get_hs_credit_per_sys_pipe_for_profiling =
					gb10b_perf_get_hs_credit_per_sys_pipe_for_profiling,
...
static const struct gops_bus gb20c_ops_bus = {
...
static const struct gops_ptimer gb20c_ops_ptimer = {
#ifdef CONFIG_NVGPU_IOCTL_NON_FUSA
	.read_ptimer = ga10b_func_read_ptimer,
...
static const struct gops_css gb20c_ops_css = {
...
static const struct gops_falcon gb20c_ops_falcon = {
	...
	.video_boot_done_value = gb20c_video_boot_done_value,
	.get_bootplugin_fw_name = gb20c_get_bootplugin_fw_name,
};

static const struct gops_priv_ring gb20c_ops_priv_ring = {
	/* gm20b_gb10b_fix_missing */
...
static const struct gops_fuse gb20c_ops_fuse = {
	...
	.fuse_status_opt_cpc_gpc = gb20c_fuse_status_opt_cpc_gpc,
};

static const struct gops_top gb20c_ops_top = {
	.device_info_parse_enum = NULL,
	.device_info_parse_data = NULL,
	.parse_next_device = gb10b_top_parse_next_dev,
	.get_expected_chip_info_cfg_version = gb20c_get_expected_chip_info_cfg_version,
...
static const struct gops_sysctrl gb20c_ops_sysctrl = {
	.init_hw = gb10b_sysctrl_init_hw,
};

#ifdef CONFIG_NVGPU_STATIC_POWERGATE
static const struct gops_tpc_pg gb20c_ops_tpc_pg = {
	/*
...
static const struct gops_grmgr gb20c_ops_grmgr = {
#ifdef CONFIG_NVGPU_MIG
	...
	.get_runlist_config_reg_off = gb20c_runlist_config_reg_off,
...
#ifdef CONFIG_NVGPU_HAL_NON_FUSA
static const struct gops_mssnvlink gb20c_ops_mssnvlink = {
	.get_links = NULL,
	.init_soc_credits = NULL,
};
#endif

static const struct gops_cic_mon gb20c_ops_cic_mon = {
	.init = gb10b_cic_mon_init,
	.report_err = nvgpu_cic_mon_report_err_safety_services
};

static const struct gops_gin gb20c_ops_gin = {
	.init = gb10b_gin_init,
...
static const struct gops_lrc gb20c_ops_lrc = {
#ifdef CONFIG_NVGPU_DEBUGGER
	.pri_is_lrcc_addr = NULL,
	.pri_is_lrcs_addr = NULL,
	.pri_is_lrcs_lrccs_addr = NULL,
	.split_lrcc_broadcast_addr = NULL,
	.split_lrc_broadcast_addr = NULL,
#endif /* CONFIG_NVGPU_DEBUGGER */
	.init_hw = NULL,
	.is_lrc_supported = false,
};

int gb20c_init_hal(struct gk20a *g)
{
	struct gpu_ops *gops = &g->ops;

	if (g->params.gpu_impl == 0x0B)
		g->params.gpu_impl = 0x0C;

	g->name = "gb20c";

	gops->acr = gb20c_ops_acr;
	gops->func = gb20c_ops_func;
	gops->bios = gb20c_ops_bios;
	gops->ecc = gb20c_ops_ecc;
	gops->ltc = gb20c_ops_ltc;
	gops->ltc.intr = gb20c_ops_ltc_intr;
#ifdef CONFIG_NVGPU_COMPRESSION
	gops->cbc = gb20c_ops_cbc;
#endif
	gops->ce = gb20c_ops_ce;
	gops->gr = gb20c_ops_gr;
	gops->gr.ecc = gb20c_ops_gr_ecc;
	gops->gr.ctxsw_prog = gb20c_ops_gr_ctxsw_prog;
	gops->gr.config = gb20c_ops_gr_config;
#ifdef CONFIG_NVGPU_FECS_TRACE
	gops->gr.fecs_trace = gb20c_ops_gr_fecs_trace;
#endif /* CONFIG_NVGPU_FECS_TRACE */
	gops->gr.setup = gb20c_ops_gr_setup;
#ifdef CONFIG_NVGPU_GRAPHICS
	gops->gr.zbc = gb20c_ops_gr_zbc;
	gops->gr.zcull = gb20c_ops_gr_zcull;
#endif /* CONFIG_NVGPU_GRAPHICS */
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->gr.hwpm_map = gb20c_ops_gr_hwpm_map;
#endif
	gops->gr.init = gb20c_ops_gr_init;
	gops->gr.intr = gb20c_ops_gr_intr;
	gops->gr.falcon = gb20c_ops_gr_falcon;
	gops->gpu_class = gb20c_ops_gpu_class;
	gops->fb = gb20c_ops_fb;
	gops->xtl = gb20c_ops_xtl;
	gops->sysctrl = gb20c_ops_sysctrl;
	gops->fb.ecc = gb20c_ops_fb_ecc;
	gops->fb.intr = gb20c_ops_fb_intr;
#ifdef CONFIG_NVGPU_HAL_NON_FUSA
	gops->fb.vab = gb20c_ops_fb_vab;
#endif
	gops->nvenc = gb20c_ops_nvenc;
	gops->ofa = gb20c_ops_ofa;
	gops->nvdec = gb20c_ops_nvdec;
	gops->nvjpg = gb20c_ops_nvjpg;
	gops->cg = gb20c_ops_cg;
	gops->fifo = gb20c_ops_fifo;
	gops->engine = gb20c_ops_engine;
	gops->pbdma = gb20c_ops_pbdma;
	gops->sync = gb20c_ops_sync;
#ifdef CONFIG_TEGRA_GK20A_NVHOST
	gops->sync.syncpt = gb20c_ops_sync_syncpt;
#endif /* CONFIG_TEGRA_GK20A_NVHOST */
#ifdef CONFIG_NVGPU_SW_SEMAPHORE
	gops->sync.sema = gb20c_ops_sync_sema;
#endif
	gops->engine_status = gb20c_ops_engine_status;
	gops->pbdma_status = gb20c_ops_pbdma_status;
	gops->ramfc = gb20c_ops_ramfc;
	gops->ramin = gb20c_ops_ramin;
	gops->runlist = gb20c_ops_runlist;
	gops->userd = gb20c_ops_userd;
	gops->channel = gb20c_ops_channel;
	gops->tsg = gb20c_ops_tsg;
	gops->usermode = gb20c_ops_usermode;
	gops->netlist = gb20c_ops_netlist;
	gops->mm = gb20c_ops_mm;
	gops->mm.mmu_fault = gb20c_ops_mm_mmu_fault;
	gops->mm.cache = gb20c_ops_mm_cache;
	gops->mm.gmmu = gb20c_ops_mm_gmmu;
	gops->therm = gb20c_ops_therm;
	gops->pmu = gb20c_ops_pmu;
#ifdef CONFIG_NVGPU_CLK_ARB
	gops->clk_arb = gb20c_ops_clk_arb;
#endif
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->regops = gb20c_ops_regops;
#endif
	gops->mc = gb20c_ops_mc;
	gops->debug = gb20c_ops_debug;
#ifdef CONFIG_NVGPU_DEBUGGER
	gops->debugger = gb20c_ops_debugger;
	gops->perf = gb20c_ops_perf;
	gops->perfbuf = gb20c_ops_perfbuf;
#endif
#ifdef CONFIG_NVGPU_PROFILER
	gops->pm_reservation = gb20c_ops_pm_reservation;
	gops->profiler = gb20c_ops_profiler;
#endif
	gops->bus = gb20c_ops_bus;
	gops->ptimer = gb20c_ops_ptimer;
#if defined(CONFIG_NVGPU_CYCLESTATS)
	gops->css = gb20c_ops_css;
#endif
	gops->falcon = gb20c_ops_falcon;
	gops->gsp = gb20c_ops_gsp;
	gops->priv_ring = gb20c_ops_priv_ring;
	gops->fuse = gb20c_ops_fuse;
	gops->top = gb20c_ops_top;
#ifdef CONFIG_NVGPU_STATIC_POWERGATE
	gops->tpc_pg = gb20c_ops_tpc_pg;
#endif
	gops->grmgr = gb20c_ops_grmgr;
	gops->cic_mon = gb20c_ops_cic_mon;
	gops->gin = gb20c_ops_gin;
	gops->lrc = gb20c_ops_lrc;
	gops->chip_init_gpu_characteristics = gb20c_init_gpu_characteristics;
	gops->get_litter_value = gb20c_get_litter_value;
	...
	/* NVGPU - Disable MULTIMEDIA in DBG mode if NVDEC bins are not present */
	if (g->ops.pmu.is_debug_mode_enabled(g)) {
		if (nvgpu_gb20c_nvdec_fw_present(g)) {
			nvgpu_set_enabled(g, NVGPU_SUPPORT_MULTIMEDIA, true);
		} else {
			nvgpu_set_enabled(g, NVGPU_SUPPORT_MULTIMEDIA, false);
		}
	} else {
		nvgpu_set_enabled(g, NVGPU_SUPPORT_MULTIMEDIA, true);
	}
	...
	nvgpu_set_enabled(g, NVGPU_SUPPORT_CCU_PROF, true);
	...
	nvgpu_set_enabled(g, NVGPU_SUPPORT_SET_CTX_MMU_DEBUG_MODE_GCC, true);
#endif
	...
	/* Disable GSP_SCHED for NVGPU_MSUBMIT */
	 ...
	 * gb20c_init_gpu_characteristics call.
	 */
...
#ifdef CONFIG_NVGPU_HAL_NON_FUSA
	gops->mssnvlink = gb20c_ops_mssnvlink;
#endif
	...
	/*
	 * TODO: NVGPU-9992
	 * untill allow list is implemented, skip the allow_list verification at regops
	 */
	g->allow_all = false;
