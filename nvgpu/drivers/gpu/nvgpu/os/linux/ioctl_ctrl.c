				  ...
				  u8 *share_token)
{
	...
	nvgpu_assert(share_token_sz == (src_inst_id_sz + token_sz));
	...
	memcpy(&first_part, share_token, sizeof(u64));
	memcpy(&second_part, share_token + src_inst_id_sz, sizeof(u64));
