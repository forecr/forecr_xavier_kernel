...
struct gk20a_platform gb20c_vf_tegra_platform = {
	...
	.enable_gpc_rg          = false,
	.enable_aelpg           = false,
	.enable_nvdec_elpg      = false,
	.enable_nvenc_elpg      = false,
	.enable_ofa_elpg        = false,
	.can_slcg               = false,
	.can_blcg               = false,
	.can_elcg               = false,
	...
	/*
	 * Get frequencies from device tree OPP table (for thermal throttling),
	 * with fallback to default frequencies if OPP not configured
	 */
	.get_clk_freqs = vgpu_plat_get_clk_freqs_opp,

	/* frequency scaling configuration */
	.devfreq_governor = "performance",
