...
enable_rt()
{
	if [ -f "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.defconfig ]; then
		...
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/dsboard_agx_defconfig\
			"${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.dsboard_agx_defconfig
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/dsboard_nx2_defconfig\
			"${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.dsboard_nx2_defconfig
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/dsboard_ornx_defconfig\
		...
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/milboard_agx_defconfig\
			"${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.milboard_agx_defconfig
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/milboard_ornx_defconfig\
		...
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/raiboard_agx_defconfig\
			"${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.raiboard_agx_defconfig
		cp -p "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/raiboard_ornx_defconfig\
		...
		#make temporary copy of the forecr custom defconfig files
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_agx_defconfig"
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_nx2_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_nx2_defconfig"
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_ornx_defconfig"\
		...
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.milboard_agx_defconfig"
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_ornx_defconfig"\
		...
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/raiboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.raiboard_agx_defconfig"
		cp -pf "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/raiboard_ornx_defconfig"\
		...
		"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/scripts/config" --file "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_thrmax_defconfig"\
			--enable PREEMPT_RT  --disable DEBUG_PREEMPT\
			--disable KVM\
			--enable EMBEDDED\
			--enable EXPERT\
		...
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_agx_defconfig"\
				"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_agx_defconfig"
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_nx2_defconfig"\
				"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_nx2_defconfig"
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.dsboard_ornx_defconfig"\
		...
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.milboard_agx_defconfig"\
				"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_agx_defconfig"
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.milboard_ornx_defconfig"\
		...
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.raiboard_agx_defconfig"\
				"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/raiboard_agx_defconfig"
		cp -pfnrs "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.updated.raiboard_ornx_defconfig"\
...
disable_rt()
{
	if [ -f "${SCRIPT_DIR}"/kernel/"${KERNEL_SRC_DIR}"/arch/arm64/configs/.orig.defconfig ]; then
		...
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.dsboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_agx_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.dsboard_nx2_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_nx2_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.dsboard_ornx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_ornx_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.dsboard_thrmax_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/dsboard_thrmax_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.milboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_agx_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.milboard_ornx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_ornx_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.milboard_thr_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/milboard_thr_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.raiboard_agx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/raiboard_agx_defconfig"
		cp -p "${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/.orig.raiboard_ornx_defconfig"\
			"${SCRIPT_DIR}/kernel/${KERNEL_SRC_DIR}/arch/arm64/configs/raiboard_ornx_defconfig"
