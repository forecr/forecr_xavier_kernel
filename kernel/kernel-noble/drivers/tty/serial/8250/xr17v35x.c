...
// function prototypes
int serialxr_register_port(struct uart_port*, unsigned short, unsigned char);
void serialxr_unregister_port(int);
void pciserial_remove_ports_xr17v35x(struct serial_private*);
