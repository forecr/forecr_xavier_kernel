...
static void __nvoc_init_funcTable_Memory_1(Memory *pThis) {
    ...
    // memCtrlCmdMapMemoryForGpuAccess -- exported (id=0x410122)
#if !NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x0u)
    pThis->__memCtrlCmdMapMemoryForGpuAccess__ = &memCtrlCmdMapMemoryForGpuAccess_IMPL;
#endif

    // memCtrlCmdUnmapMemoryForGpuAccess -- exported (id=0x410153)
#if !NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x0u)
    pThis->__memCtrlCmdUnmapMemoryForGpuAccess__ = &memCtrlCmdUnmapMemoryForGpuAccess_IMPL;
#endif
} // End __nvoc_init_funcTable_Memory_1 with approximately 4 basic block(s).
